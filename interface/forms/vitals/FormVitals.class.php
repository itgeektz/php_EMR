...
class FormVitals extends ORDataObject {
  ...
  function set_date($dt) {
	...
	function get_oxygen_method() {
		return $this->oxygen_method;
	}
	function set_oxygen_method($om) {
			$this->oxygen_method = $om;
	}

	function get_oxygen_amt() {
		return $this->oxygen_amt;
	}
	function set_oxygen_amt($oa) {
			$this->oxygen_amt = $oa;
	}
