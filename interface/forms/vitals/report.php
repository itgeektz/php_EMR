...
function vitals_report( $pid, $encounter, $cols, $id, $print = true) {
  ...
  if ($data) {
    ...
    foreach($data as $key => $value) {
      ...
      elseif ($key == "Oxygen Method" || $key == "Abg" || $key == "Fbg" || $key == "Oxygen Amt") {
        //$value = number_format($value,0);
        if ($key == "Abg") {
          $vitals .= "<td><span class=bold>" . xl('Random Blood Sugar') . ": </span><span class=text>" . $value . "</span></td>";
        }
        elseif ($key == "Fbg") {
          $vitals .= "<td><span class=bold>" . xl('Fasting Blood Sugar') . ": </span><span class=text>" . $value . "</span></td>";
        }
        elseif ($key == "Oxygen Method") {
          $vitals .= "<td><span class=bold>" . xl('Oxygen Method') . ": </span><span class=text>" . $value . "</span></td>";
        }
        elseif ($key == "Oxygen Amt") {
          $vitals .= "<td><span class=bold>" . xl('Oxygen Amount') . ": </span><span class=text>" . $value . " " . xl('ltr') . "</span></td>";
        }
        else {
