...
<script>
     var form_patient=window.opener.document.getElementById("form_patient");
      var searchid=window.opener.document.getElementById("form_pid");
       var id= <?php echo $pid; ?> ;
       var textsearch="<?php echo $_POST["form_lname"].', '.$_POST["form_fname"].' '.$_POST["form_mname"]; ?>";

        searchid.value=id;
        form_patient.value=textsearch;
        window.close();
</script>
