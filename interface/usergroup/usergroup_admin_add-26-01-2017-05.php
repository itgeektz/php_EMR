...
?>
  ...
  <td><textarea name=info style="width:120px;" cols=27 rows=4 wrap=auto></textarea></td>
      ...
      <select name="qualification">
        ...
        if ($fres) {
          ...
          foreach($result as $iter) {
              ...
              echo '<option value='.$iter["option_id"].'>'.$iter["title"].'</option>';
          }
        }
        ?>
      </select>
    ...
    <td><input type="entry" name="designation" style="width:120px;"></td>
  </tr>
  <tr id="UploadSignature-tr"  style="display: none;">
      <td><span class="text"><?php  xl('UploadSignature','e'); ?>: </span></td>
    <td colspan="3"><input type="file" name="signature"   value="Upload"><input type="hidden" name="isdoctor" id="isdoctor" value="0"></td>
  </tr>
