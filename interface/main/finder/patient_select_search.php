...
$(document).ready(function(){
    ...
    $(".oneresult").click(function() { 
      var form_patient=window.opener.opener.document.getElementById("form_patient");
      var searchid=window.opener.opener.document.getElementById("form_pid");
       var id= $(this).attr('id');
        textsearch=$("#"+id+" > .srName").html();
