...
function searchme() {
 var f = document.forms[0];
 var url = '../finder/patient_select_search.php?popup=1';
...
<form action='../../new/new_comprehensive_save_search.php' name='demographics_form' method='post' onsubmit='return validate(this)'>
...
?>
        ...
        var url = '../../new/new_search_popup_search.php';
...
<!--
<script>
$("#form_title option:first").html("Please select")
$('#form_fname').attr("placeholder","First name");
$('#form_mname').attr("placeholder","Midal name");
$('#form_lname').attr("placeholder","Last name");
$("#form_sex option:first").html("Please select")
$("#form_status option:first").html("Please select")
$("#form_occupation option:first").html("Please select")
$('#form_monthly_income').attr("placeholder","Income(pa)");
$('#form_education').attr("placeholder","Education");
$("#form_blood_group option:first").html("Please select"); 

$('#form_billing_note').attr("placeholder","Billing number");
$('#form_mother_tongue').attr("placeholder","Mother tongue");
$("#form_patient_category option:first").html("Please select"); 

$('#form_pubpid').attr("placeholder","MRN");
$('#form_file_number').attr("placeholder","File number");
$('#form_DOB').attr("placeholder","Birth Date");
$("#form_religion option:first").html("Please select"); 
$('#form_Emp_number').attr("placeholder","Employee number");
$("#form_country_code option:first").html("Please select"); 

//current address
$('#form_city').attr("placeholder","City");
$('#form_street').attr("placeholder","Address");
$('#form_area').attr("placeholder","Area");
$('#form_ps').attr("placeholder","P.S");
$('#form_district').attr("placeholder","District");
$('#form_phone_home').attr("placeholder","Phone no");
$('#form_pat_mobile1').attr("placeholder","Mobile no");
$('#form_email').attr("placeholder","Email ID");

$('#form_state').attr("placeholder","State");
$('#form_po_box').attr("placeholder","P.O Box");
$('#form_pin').attr("placeholder","Pin");
$('#form_phone_cell').attr("placeholder","Phone");
$('#form_pat_alt_mob1').attr("placeholder","Mobile number");
$('#form_phone_cell').attr("placeholder","Phone");

$("#form_country option:first").html("Please select"); 
//Current Address
$('#form_perm_city').attr("placeholder","City");
$('#form_perm_addr').attr("placeholder","Address");
$('#form_perm_area').attr("placeholder","Area");
$('#form_perm_ps').attr("placeholder","P.S");
$('#form_perm_district').attr("placeholder","District");
$('#form_perm_pat_mobile').attr("placeholder","Phone no");
$('#form_perm_pat_mobile1').attr("placeholder","Mobile no");
$('#form_perm_email').attr("placeholder","Email ID");

$('#form_perm_state').attr("placeholder","State");
$('#form_perm_po_box').attr("placeholder","P.O Box");
$('#form_perm_pin').attr("placeholder","Pin");
$('#form_perm_phone_cell').attr("placeholder","Phone");
$('#form_perm_alt_mob').attr("placeholder","Phone");
$('#form_perm_alt_mob1').attr("placeholder","Mobile number");


//Relative detail
$('#form_rel_fname').attr("placeholder","First name");
$('#form_rel_mname').attr("placeholder","Middel name");
$('#form_rel_lname').attr("placeholder","Last name");
$("#form_relation option:first").html("Please select");
$("#form_relative_profession option:first").html("Please select");
$('#form_rel_mob').attr("placeholder","Phone");
$('#form_rel_mob1').attr("placeholder","Mobile number");
$('#form_rel_alt_phone').attr("placeholder","Phone");
$('#form_rel_alt_phone1').attr("placeholder","Mobile number");

//Registering Dept
$("#form_reg_dept option:first").html("Please select");
$('#form_reg_doctor').attr("placeholder","Registerting doctor");
$('#form_chief_complaint').attr("placeholder","Chief complaint");

//Referrer Details
$("#form_referrer_type option:first").html("Please select");
$('#form_ref_name').attr("placeholder","Referrer name");
$('#form_referrer_hosp').attr("placeholder","Referrer hospital");
$('#form_ref_phone').attr("placeholder","Phone");
$('#form_ref_phone1').attr("placeholder","Mobile number");

//Insurance


$("#form_referrer_type option:first").html("Please select");
$('input[name="i1plan_name"]').attr("placeholder","Plan name");
$('#i1effective_date').attr("placeholder","Effective date");
$('input[name="i1policy_number"]').attr("placeholder","Policy number");
$('input[name="i1group_number"]').attr("placeholder","Group number");

$('input[name="i1subscriber_employer"]').attr("placeholder","Subscriber employer");
$('input[name="i1subscriber_employer_street"]').attr("placeholder","SE address");
$('input[name="i1subscriber_employer_city"]').attr("placeholder","SE city");

$('input[name="i1subscriber_employer_postal_code"]').attr("placeholder","SE zip code");
$("#form_i1subscriber_employer_state option:first").html("Please select");
$("#form_i1subscriber_employer_country option:first").html("Please select");

$('input[name="i1subscriber_fname"]').attr("placeholder","First name");
$('input[name="i1subscriber_mname"]').attr("placeholder","Middel name");
$('input[name="i1subscriber_lname"]').attr("placeholder","Last name");
$("#form_i1subscriber_relationship option:first").html("Please select");

$('#i1subscriber_DOB').attr("placeholder","Birth date");
$('input[name="i1subscriber_ss"]').attr("placeholder","Middel name");
$('input[name="form_i1subscriber_sex"] option:first').html("Please select");
$('input[name="i1subscriber_street"]').attr("placeholder","Last name");
