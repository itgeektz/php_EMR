...
<script type='text/javascript'>
    ...
    function edit_allergy(){
        ...
        $('.btn_allergy').hide();
          $.ajax({
            url: "../../patient_file/summary/add_edit_allergy.php",
            async: false,
            success: function(response){
              $('#allergy_ps_expand').empty().append(response);
            }
          });
      return false;
    }
...
// To remove medication from the stats demographics page
unset($ISSUE_TYPES['medication']);
