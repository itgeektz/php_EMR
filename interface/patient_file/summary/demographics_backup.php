      	...
      	<div style='float:left; margin-right:20px;width: 98%;'>
     			<table class="demo_table" cellspacing=0 cellpadding=0 style="width: 100%;">
						<?php 
									...
									<!--@author: Sathya Anand, ViSolve
											@Purpose: Billing history of the patient will be displayed as readonly
										@Date: June,2016 -->
							...
							<?php
									...
									if ( $insurance_count > 0 ) 
									{
										...
										<ul class="tabNav"><?php
											...
											echo "<li><a href='/play/javascript-tabbed-navigation/'>" .	htmlspecialchars( xl('Eligibility'), ENT_NOQUOTES) . "</a></li>";
											?></ul><?php						
										} ?>
									 <div class="tabContainer">
								<?php
...
$(document).ready(function(){
	...
	<?php /* ?>
		...
		var skipArray = [<?php echo $condition_str; ?>];
		checkSkipConditions();
		var frm_save = <?php echo isset($_REQUEST['frm_save']) ? $_REQUEST['frm_save'] : '0' ;  ?>;
		if(frm_save){
		  edit_soap(<?php echo $soap_form_id ?>);
		  toggleIndicator(this,"vitals_ps_expand");
		  setTimeout(function(){
		    toggleIndicator(this,"allergy_ps_expand");
		  }, 1500);
	...
	<?php  ?>
		...
		<?php 
			if(isset($_GET['visit']))
			{?>
				//alert('visit(encounter) successfully created.');
				<?php 	
			}?>
