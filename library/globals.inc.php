...
$GLOBALS_METADATA = array(
  ...
  'Billing' => array(
    ...
    'pending_document_disp_time_hour' => array(
      xl('Pending document display time'),
      'text',                           // data type
      '1',                     // default
      xl('Pending Document display time in hours day month year.')
    ),

    'pending_document_disp_time_duration' => array(
            xl('Pending document disp time duration'),
            array(
                'HOUR' => xl('Hour'),
                'DAY' => xl('Day'),
                'MONTH' => xl('Month'),
            ...
            'HOUR',                              // default
            xl('Option to pending document duration type.')
        ),
  ...
  'Connectors' => array(
    ...
    'rmcapi_username' => array(
      xl('RMC API Username'),
      'text',
      'admin',
      xl('Username for RMC API')
    ),

    'rmcapi_password' => array(
      xl('RMC API Password'),
      'pass',
      'Regency2016',
      xl('Password')
