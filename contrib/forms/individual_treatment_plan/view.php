...
?>
<form method=post action="<?php echo $rootdir?>/forms/individual_treatment_plan/save.php?mode=update&id=<?php echo $_GET["id"];?>" name="my_form">
...
<textarea cols=85 rows=2 wrap=virtual name="diagnosis_description" ><?php echo stripslashes($obj{"diagnosis_description"});?></textarea><br><br>
...
<textarea cols=85 rows=3 wrap=virtual name="long_term_goals" ><?php echo stripslashes($obj{"long_term_goals"});?></textarea><br><br>
