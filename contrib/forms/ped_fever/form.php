...
<TR>
	<TD>Fever: </TD>
	<TD>
	<INPUT TYPE="text" NAME="fever_temp" value="<?php if ($obj["fever_temp"]!='') print $obj["fever_temp"]; ?>">
	</TD>
	<TD>Measured:</TD>
	<TD>
		<SELECT NAME="measured">
		<option <?php if ($obj["measured"]=='axillary') print 'selected' ;?> >axillary
		<option <?php if ($obj["measured"]=='oral') print 'selected' ;?> >oral
		<option <?php if ($obj["measured"]=='rectal') print 'selected' ;?> >rectal
		<option <?php if ($obj["measured"]=='not measured') print 'selected' ;?> >not measured
		</SELECT>	
	</TD>
	<TD>Duration:</TD>
	<TD>
...
<TR>
	...
	<TD>
		...
		<option <?php if ($obj["responds_to_tylenol"]=='n/a') print 'selected'; ?>>n/a
		<option <?php if ($obj["responds_to_tylenol"]=='no') print 'selected'; ?>>no
		<option <?php if ($obj["responds_to_tylenol"]=='yes') print 'selected'; ?>>yes
	</TD>
	<TD>Responds to Molrtin</TD>
	<TD>
		<SELECT NAME="responds_to_moltrin">
		<option <?php if ($obj["responds_to_moltrin"]=='n/a') print 'selected'; ?>>n/a
		<option <?php if ($obj["responds_to_moltrin"]=='no') print 'selected'; ?>>no
		<option <?php if ($obj["responds_to_moltrin"]=='yes') print 'selected'; ?>>yes
