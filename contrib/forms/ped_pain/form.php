...
<TR>
	...
	<TD>
		...
		<option <?php if ($obj["location"]=='ear') print 'selected' ;?> >ear
		<option <?php if ($obj["location"]=='troat') print 'selected'; ?>>troat
		<option <?php if ($obj["location"]=='stomach') print 'selected'; ?>>stomach
		<option <?php if ($obj["location"]=='head') print 'selected'; ?>>head
		</SELECT>
	</TD>
	<TD >Duration:</TD>
	<TD>
	...
	<TD>
		...
		<option <?php if ($obj["severity"]=='consolable') print 'selected'; ?>>consolable
		<option <?php if ($obj["severity"]=='consolable with difficulty') print 'selected'; ?>>consolable with difficulty
		<option <?php if ($obj["severity"]=='inconsolable') print 'selected'; ?>>inconsolable
		</SELECT>
	</TD>
</TR>
<TR>
	...
	<TD>
		...
		<option <?php if ($obj["fever"]=='98') print 'selected'; ?>>98
		<option <?php if ($obj["fever"]=='98,5') print 'selected'; ?>>98,5
		<option <?php if ($obj["fever"]=='99') print 'selected'; ?>>99
		<option <?php if ($obj["fever"]=='99,5') print 'selected'; ?>>99,5
		<option <?php if ($obj["fever"]=='100') print 'selected'; ?>>100
		<option <?php if ($obj["fever"]=='100,5') print 'selected'; ?>>100,5
		<option <?php if ($obj["fever"]=='101') print 'selected'; ?>>101
		<option <?php if ($obj["fever"]=='101,5') print 'selected'; ?>>101,5
		<option <?php if ($obj["fever"]=='102') print 'selected'; ?>>102
		<option <?php if ($obj["fever"]=='102,5') print 'selected'; ?>>102,5
		<option <?php if ($obj["fever"]=='103') print 'selected'; ?>>103
		<option <?php if ($obj["fever"]=='103,5') print 'selected'; ?>>103,5
		<option <?php if ($obj["fever"]=='104') print 'selected'; ?>>104
		<option <?php if ($obj["fever"]=='104,5') print 'selected'; ?>>104,5
		<option <?php if ($obj["fever"]=='105 ') print 'selected'; ?>>105
		</SELECT>
	</TD>
	<TD >Lethargy:</TD>
	<TD>
	...
	<TD>
		...
		<option <?php if ($obj["vomiting"]=='no') print 'selected'; ?>>no
		<option <?php if ($obj["vomiting"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
</TR>
<TR>
...
<TR>
	...
	<?php if ($obj["notes"]!='') print $obj["notes"]; ?>
	</TEXTAREA></TD>
</TR>
</TABLE>
